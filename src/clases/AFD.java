...
//                System.out.println("Transicion: "+c+"->"+R.get(0).getIdentificador());
    ...
    //Genera la tabla AFD en un arreglo bidimencional de enteros
    public void generarArrayTabla() {
        //ArrayList<ArrayList<Integer>> tablaAFD = new ArrayList<ArrayList<Integer>>();
    ...
    public ArrayList<ArrayList<Integer>> getTablaAFD() {
        return tablaAFD;
    }

    public void setTablaAFD(ArrayList<ArrayList<Integer>> tablaAFD) {
