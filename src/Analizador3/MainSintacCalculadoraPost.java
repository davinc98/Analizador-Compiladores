 ...
 * DEL EJERCICIO CON GRAMATICA SIN RECURSION SIGUIENTE: PARA UNA CALCULADORA
 * PARA NUMEROS ENTEROS DE UN DIGITO, Y CONVERSION DE UNA CADENA A POSTFIJO
 * 
 *          E -> TE'
 *          E' -> +TE' | -TE' | Epsilon
 *          T -> FT'
 ...
 * 
 */
public class MainSintacCalculadoraPost {
    ...
    public static void main (String[] args){  
        ...
        crearAutomataBasicoAFN('0', '9');//6//num ENTERO de UN digito
        ...
        //ANALIZADOR LEXICO
        System.out.println("\n\nANALIZADOR LEXICO CONVERSION A POSTFIJO");

        //num+num+num
        String CadenaparaAnalizar = "2+4*8";
        SintacCalculadoraPost sintact = new SintacCalculadoraPost(tablaAFD, CadenaparaAnalizar);                   
        Cadena V = new Cadena();
        if(sintact.E(V))
            System.out.println("\n\nCadena valida: "+ V.getCadena());
        else
            System.out.println("\n\nCadena no valida.");
