 ...
 * PARA NUMEROS ENTEROS DE UN DIGITO
 * 
 *          E -> TE'
 *          E' -> +TE' | -TE' | Epsilon
 *          T -> FT'
 ...
 * 
 */
public class MainSintacCalculadora {
    ...
    public static void main (String[] args){        
        ...
        //num+num+num
        String CadenaparaAnalizar = "2+2+1+5/(5*2)+9";
        SintacCalculadora sintact = new SintacCalculadora(tablaAFD, CadenaparaAnalizar);                   
        Numero V = new Numero();
        if(sintact.E(V))
            System.out.println("\n\nCadena valida: "+ V.getValor());
        else
            System.out.println("\n\nCadena no valida.");
